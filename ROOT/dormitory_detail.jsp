...
<%
    ...
    int id = 0;
    if (idStr == null) {
        out.println("<script>alert('잘못된 접근입니다.');location.href='dormitory_board.jsp?page="+pageBack+"';</script>");
        return;
    }
    ...
    try {
        ...
        // 게시글 정보
        String sql = "SELECT * FROM dormitory_board WHERE id=?";
        ...
        out.println("<script>alert('DB 오류 발생');location.href='dormitory_board.jsp?page="+pageBack+"';</script>");
        return;
    } finally {
    ...
    <main>
        <div class="container">
            ...
            <div class="button-box">
                <a href="dormitory_board.jsp?page=<%= pageBack %>">목록으로</a>
            </div>
        </div>
        ...
        <div class="comment-section">
            <% if (user != null) { %>
                <form action="dormitory_comment_process" method="post" class="comment-form">
    ...
    for(Map<String,Object> cmt : roots){ %>
        <div class="comment">
            ...
            if(user != null) { %>
                ...
                <form action="dormitory_comment_process" method="post" id="replyForm_<%= cmt.get("comment_id") %>" class="reply-form" style="display:none;">
                    <input type="hidden" name="board_id" value="<%= id %>">

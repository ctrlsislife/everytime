...
<%
    ...
    if(user == null) {
        response.sendRedirect("delivery_board.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        * {margin:0; padding:0; box-sizing:border-box;}
        ...
        .write-form textarea {min-height:128px; resize:vertical;}
        .write-form input[type="file"] {margin-bottom:20px;font-size:15px;}
        .write-form .opts {margin-bottom:18px;}
        .write-form .opts label {font-size:15px; margin-right:14px; font-weight:normal;}
...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="dormitory.jsp">기숙사 게시판</a></li>
            <li><a href="offcampus_board.jsp">자취생 게시판</a></li>
            <li><a href="delivery_board.jsp"><b>배달 게시판</b></a></li>
    ...
    <main>
        <div class="write-form-container">
            <h2>배달 게시판 글쓰기</h2>
            <form class="write-form" action="delivery_write_process" method="post" enctype="multipart/form-data">
                ...
                <div class="opts">
                    <label>
                        <input type="checkbox" name="delivery_fee_share" value="Y" checked> 배달비 1/n
                    </label>
                    <label>
                        <input type="checkbox" name="together" value="Y" checked> 함께 먹어요
                    </label>
                </div>
                <label>게시글 사진</label>
                <input type="file" name="image_post" accept="image/*">
                <label>배달 내역 사진</label>
                <input type="file" name="image_order" accept="image/*">
                <div class="btns">
                    <button type="submit">등록</button>
                    <a href="delivery_board.jsp">취소</a>
                </div>
            </form>
        </div>
    </main>

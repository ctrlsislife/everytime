...
<%
    ...
    if(user == null) {
        response.sendRedirect("request_board.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<body>
    ...
    <main>
        <div class="write-form-container">
            <h2>게시판 요청 글쓰기</h2>
            <form class="write-form" action="request_write_process" method="post" enctype="multipart/form-data">

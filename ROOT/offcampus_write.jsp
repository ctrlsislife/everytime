...
<%
    ...
    if(user == null) {
        response.sendRedirect("offcampus_board.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<body>
    ...
    <main>
        <div class="write-form-container">
            <h2>자취생 게시판 글쓰기</h2>
            <form class="write-form" action="offcampus_write_process" method="post" enctype="multipart/form-data">
                ...
                <div class="btns">
                    ...
                    <a href="offcampus_board.jsp">취소</a>
                </div>
            </form>
        </div>
    </main>

...
<%
    String msg = "NULL";
    String successSignup = "signup.jsp";
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (u_name == null || u_name.isEmpty()) {
            ...
            msg = "이메일을 입력해 주세요.";
        } else if (!u_passwd.equals(u_passwdConfirm)) {
            msg = "비밀번호가 일치하지 않습니다.";
            successSignup = "signup.jsp?name=" + u_name + "&username=" + u_username + "&email=" + u_email;
        } else {
            ...
            try {
                ...
                if (rs.next()) {
                    msg = "이미 사용 중인 아이디입니다.";
                    successSignup = "signup.jsp?name=" + u_name + "&email=" + u_email;
                } else {
                    // 비밀번호 암호화(SHA-256 + Base64)
                    MessageDigest md = MessageDigest.getInstance("SHA-256");
                    md.update(u_passwd.getBytes("UTF-8"));

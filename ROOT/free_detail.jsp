...
<%
    ...
    int id = 0;
    if (idStr == null) {
        out.println("<script>alert('잘못된 접근입니다.');location.href='free_board.jsp?page="+pageBack+"';</script>");
        return;
    }
    ...
    try {
        ...
        out.println("<script>alert('DB 오류 발생');location.href='free_board.jsp?page="+pageBack+"';</script>");
        return;
    } finally {
    ...
    <main>
        <div class="container">
            ...
            <div class="button-box">
                <a href="free_board.jsp?page=<%= pageBack %>">목록으로</a>
            </div>
        </div>
        ...
        <div class="comment-section">
            <% if (user != null) { %>
                <form action="free_comment_process" method="post" class="comment-form">
    ...
    for(Map<String,Object> cmt : roots){ %>
        <div class="comment">
            ...
            if(user != null) { %>
                ...
                <form action="free_comment_process" method="post" id="replyForm_<%= cmt.get("comment_id") %>" class="reply-form" style="display:none;">
                    <input type="hidden" name="board_id" value="<%= id %>">

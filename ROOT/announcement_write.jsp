    ...
    <style>
        * {margin: 0; padding: 0; box-sizing: border-box;}
        ...
        main {
            ...
            min-height: calc(100vh - 100px); background: #f9f9f9;
        ...
        .write-form .img-preview {
            margin-bottom: 18px;
            text-align: center;
        }
        .write-form .img-preview img {
            max-width: 320px;
            max-height: 240px;
            border-radius: 7px;
            border: 1px solid #ccc;
...
<body>
    ...
    <main>
        <div class="write-form-container">
            <h2>공지사항 등록</h2>
            <form class="write-form" action="announcement_upload" method="post" enctype="multipart/form-data">
                ...
                <input type="file" id="file" name="file" accept="image/*" onchange="previewImg(event)">
                <div class="img-preview" id="imgPreview"></div>

                <div class="btns">
                    <button type="submit">등록</button>
                    <a href="announcement.jsp">취소</a>
                </div>
            </form>
        </div>
    </main>
    ...
    function previewImg(event) {
        ...
        if(file && file.type.startsWith("image/")) {
            ...
            reader.onload = function(e) {
                pre.innerHTML = '<img src="'+e.target.result+'" alt="preview">';
            }

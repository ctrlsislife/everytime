...
<head>
    ...
    <title>Place 4 You - 회원 정보 수정</title>
    <style>
        body {
...
<body>
	...
	<div class="edit-container">
		<div class="subtitle"><b>회원 정보 수정</b></div>
        <form action="edit_process.jsp" method="POST">
            <!-- 읽기 전용 -->
            <div class="form-group-readonly">
                <label for="name"><b>이름: <%= user.getName() %></b></label>
            </div><br><br>
            
            <div class="form-group-readonly">
                <label for="username"><b>아이디: <%= user.getUsername() %></b></label>
            </div><br><br>

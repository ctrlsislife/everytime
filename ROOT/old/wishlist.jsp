    ...
    <div class="search-container">
		...
		<%
            ...
            try {
                ...
                String sql = "SELECT r.*, w.* FROM recommendations r " +
                             "JOIN wishlist w ON r.recommendation_id = w.recommendation_id " +
                             "WHERE w.username = ?";
                ...
                if (rs.next()) {
                    ...
                    out.println("<div class='error-message'>찜하신 장소가 없습니다.</div>");

...
<head>
    ...
    <title>PLACE 4 YOU - 비밀번호 오류</title>
    <style>
        body {
    ...
    <div class="top-bar">
   	...
   	<div class="signup-container">
        ...
        <div class="form-group">
            ...
            <input type="text" id="username" name="username" required placeholder="아이디를 입력하세요" value="${param.username}">
        </div><br>
        
        <div class="form-group">
            <label for="password"><b>비밀번호</b><span style="font-size: 14px; color: red;">비밀번호가 일치하지 않습니다!</span></label>
            <input type="password" id="password" name="password" style="border: 1px solid red;" required placeholder="비밀번호를 입력하세요">
        </div><br>

        <div class="form-group">
            <label for="passwordConfirm"><b>비밀번호 확인</b></label>
            <input type="password" id="passwordConfirm" name="passwordConfirm" style="border: 1px solid red;" required placeholder="비밀번호를 다시 입력하세요">
        </div><br>

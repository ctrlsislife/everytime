...
<%
    ...
    try {
        ...
        String countSql = "SELECT COUNT(*) FROM dormitory_board";
        ...
        String sql = "SELECT id, title, writer, created_at FROM dormitory_board ORDER BY id DESC LIMIT ?, ?";
    ...
    <main>
        <div class="board-container">
            <h1>
                기숙사 게시판
                <% if(user != null){ %>
                    <a href="dormitory_write.jsp" class="write-btn">글쓰기</a>
                <% } %>
            </h1>
            <table>
                <thead>
...
%>
                    <tr>
                        ...
                        <td class="board-title">
                            <a href="dormitory_detail.jsp?id=<%= row.get("id") %>&page=<%= currentPage %>"><%= row.get("title") %></a>
                        </td>
...
<% } %>
            ...
            <div class="pagination">
                <% if(currentPage > 1){ %>
                    <a class="arrow" href="dormitory_board.jsp?page=<%= currentPage-1 %>">&laquo;</a>
                <% } else { %>
                ...
                <%  } else { %>
                    <a href="dormitory_board.jsp?page=<%=i%>"><%=i%></a>
                <% }} %>
                <% if(currentPage < totalPages){ %>
                    <a class="arrow" href="dormitory_board.jsp?page=<%= currentPage+1 %>">&raquo;</a>
                <% } else { %>

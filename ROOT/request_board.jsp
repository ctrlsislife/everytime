...
<%
    ...
    try {
        ...
        String countSql = "SELECT COUNT(*) FROM request_board";
        ...
        String sql = "SELECT id, title, writer, created_at FROM request_board ORDER BY id DESC LIMIT ?, ?";
    ...
    <main>
        <div class="board-container">
            <h1>
                게시판 요청
                <% if(user != null){ %>
                    <a href="request_write.jsp" class="write-btn">글쓰기</a>
                <% } %>
            </h1>
            <table>
                <thead>
...
%>
                    <tr>
                        ...
                        <td class="board-title">
                            <a href="request_detail.jsp?id=<%= row.get("id") %>&page=<%= currentPage %>"><%= row.get("title") %></a>
                        </td>
...
<% } %>
            ...
            <div class="pagination">
                <% if(currentPage > 1){ %>
                    <a class="arrow" href="request_board.jsp?page=<%= currentPage-1 %>">&laquo;</a>
                <% } else { %>
                ...
                <%  } else { %>
                    <a href="request_board.jsp?page=<%=i%>"><%=i%></a>
                <% }} %>
                <% if(currentPage < totalPages){ %>
                    <a class="arrow" href="request_board.jsp?page=<%= currentPage+1 %>">&raquo;</a>
                <% } else { %>
